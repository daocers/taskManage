	...
	<body>
		...
		<div id="show-task" class="content scaffold-show" role="main">
			...
			<ol class="property-list task">
				...
				<g:if test="${taskInstance?.content}">
				<li class="fieldcontain">
					<span id="content-label" class="property-label"><g:message code="task.content.label" default="Content" /></span>
					
						<span class="property-value" aria-labelledby="content-label"><g:fieldValue bean="${taskInstance}" field="content"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${taskInstance?.date}">
				<li class="fieldcontain">
					<span id="date-label" class="property-label"><g:message code="task.date.label" default="Date" /></span>
					
						<span class="property-value" aria-labelledby="date-label"><g:formatDate date="${taskInstance?.date}" /></span>
